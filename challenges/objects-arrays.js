...
const universities = graduates.map((currItem) => currItem.university).sort();
...
const contactInfo = graduates.map((currItem) => `${currItem.first_name} ${currItem.email}`);
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currItem) => accumulator + currItem.population, 0);
